...
[![Docker Automated build](https://img.shields.io/docker/automated/samdoran/fedora29-ansible.svg?maxAge=2592000)](https://hub.docker.com/r/samdoran/fedora29-ansible/)
...
To run a role inside the container, you need to run the container with your role mounted inside it. I mount my current role directory as `/usr/share/ansible/roles/role_under_test` inside the container, but you can call it whatever you like.
    ...
    docker run --privileged -d --volume="$(pwd)":/usr/share/ansible/roles/role_under_test:ro --name ansible-test fedora29-ansible /sbin/init
